    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 bg-white shadow sm:rounded-lg">
                ...
                <form class="mt-6 space-y-6" method="POST" action="{{ route('bazaar.store') }}">
                    {{ csrf_field() }}

                    <div>
                        <x-input-label for="name" :value="__('Leftover Food Collection Center Name')" />
                        <x-text-input id="bazaarName" name="bazaarName" type="text" :value="old('bazaarName')" required autofocus
                    ...
                    <div>
                        ...
                        <x-text-input id="volunteerLimit" type="number" name="volunteerLimit" :value="old('volunteerLimit')"
                    ...
                    <div>
                        ...
                        <x-text-input id="bazaarAddress" name="bazaarAddress" type="text" readonly required
                            class="mt-1 block w-full" />
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        <x-primary-button>{{ __('Create Leftover Food Collection Center') }}</x-primary-button>
                    </div>
                </form>

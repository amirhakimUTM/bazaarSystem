<x-app-layout>
                                            ...
                                            @if ($foodWeight)
                                                <form action="{{ route('foodweights.update', $foodWeight) }}"
                                                    ...
                                                    <input type="number" name="weight"
                                                        value="{{ $foodWeight['weight'] }}" step="any">
                                                    <button class="btn" type="submit">Update</button>
                                                </form>
                                            @else
                                                <form action="{{ route('foodweights.store') }}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="bazaarName"
    ...
    <script>
        function filterChanged() {
            ...
            var url = '{{ route('foodweights.foodWeightListAdmin') }}?year=' + selectedYear + '&bazaarName=' + selectedBazaar;
